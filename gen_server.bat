...
del C:\DriverCodes\HideDriver\NickolasZhao\x64\Release\loader_shell.dll
...
"C:\ProgramFiles (x86)\VisualStudio\2019\Community\Common7\IDE\devenv.com"  "C:\DriverCodes\HideDriver\NickolasZhao\YSN.sln" /Rebuild "Release|x64"   /project  C:\DriverCodes\HideDriver\NickolasZhao\NewLoader\NewLoader.vcxproj  





C:\pe2shc_1.2\pe2shc.exe C:\DriverCodes\HideDriver\NickolasZhao\x64\Release\NewLoader.dll C:\DriverCodes\HideDriver\NickolasZhao\x64\Release\loader_shell.dll
